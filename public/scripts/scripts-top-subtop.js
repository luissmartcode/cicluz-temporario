...
export function exibirLista() {
    ...
    if (listaRecuperada) {
        ...
        listaRecuperada.forEach(i => {
            ...
            itemDiv.style.backgroundColor = i.est == "eu" ? "var(--cor-eu)"  : i.est == "ser" ? "var(--cor-ser)"  : i.est == "ter" ? "var(--cor-ter)"  : "var(--cor-memorias)" ;
    ...
    export async function exibirTopicos(id) {
        ...
        caixaTopico.style.color = est[0].est == "eu" ? "var(--cor-eu)" : est[0].est == "ser" ? "var(--cor-ser)" : est[0].est == "ter" ? "var(--cor-ter)"  : "var(--cor-memorias)" ;
